...
class DataValidation:
    ...
    def detect_dataset_drift(self, reference_df: DataFrame, current_df: DataFrame) -> bool:
        ...
        try:
            ...
            n_features = metrics_result['number_of_columns']
            n_drifted_features = metrics_result['number_of_drifted_columns']
            drift_status = metrics_result['dataset_drift']
